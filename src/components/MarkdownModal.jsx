    ...
    <div className="modal" id="mdModal">
      <div className="sheet" role="dialog" aria-modal="true" aria-labelledby="mdTitle">
        ...
        <div className="acts" style={{ marginTop: '10px' }}>
          <button className="act" onClick={onClose} style={{ marginRight: '5px' }}>Cancelar</button>
          <span style={{ flex: 1 }}></span>
          <button className="act danger" onClick={() => handleImport(true)} title="Borra el mapa actual" style={{ marginRight: '5px' }}>Reemplazar mapa</button>
